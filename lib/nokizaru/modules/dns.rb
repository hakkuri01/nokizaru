...
module Nokizaru
  module Modules
    ...
    module DNSEnumeration
      ...
      DNS_RECORDS = %w[
        A AAAA AFSDB APL CAA CDNSKEY CDS CERT CNAME DHCID DLV DNAME DNSKEY DS HINFO
        HIP IPSECKEY KEY KX LOC MX NAPTR NS NSEC NSEC3 NSEC3PARAM PTR RP RRSIG SIG
        SOA SRV SSHFP TKEY TLSA TSIG TXT URI
      ].freeze
